...
//       this.icon.width * 1.2 + this.text.width + 30;
//     this.background.resize(backgroundWidth, this.background.height);
//     this.setSize(this.background.width, this.background.height);
//     this.setPositions();
//   }
// }
// export interface IMnuNinePatchButtonConfig
//   extends IMenuButtonConfig,
//     ISizeConfig {}
